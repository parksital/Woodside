...
public struct CreateEventInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, type: String? = nil, name: String, date: String, description: String? = nil, eventVenueId: GraphQLID) {
    graphQLMap = ["id": id, "type": type, "name": name, "date": date, "description": description, "eventVenueId": eventVenueId]
  }
...
public struct UpdateEventInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, type: String? = nil, name: String? = nil, date: String? = nil, description: String? = nil, eventVenueId: GraphQLID? = nil) {
    graphQLMap = ["id": id, "type": type, "name": name, "date": date, "description": description, "eventVenueId": eventVenueId]
  }
...
public final class ListEventsByDateQuery: GraphQLQuery {
  public static let operationString =
    "query ListEventsByDate($type: String, $date: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection, $filter: ModelEventFilterInput, $limit: Int, $nextToken: String) {\n  eventsByDate(type: $type, date: $date, sortDirection: $sortDirection, filter: $filter, limit: $limit, nextToken: $nextToken) {\n    __typename\n    items {\n      __typename\n      id\n      name\n      venue {\n        __typename\n        name\n      }\n      date\n      description\n    }\n    nextToken\n  }\n}"
...
public final class CreateEventMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateEvent: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, type: String? = nil, name: String, venue: Venue, date: String, description: String? = nil) {
        self.init(snapshot: ["__typename": "Event", "id": id, "type": type, "name": name, "venue": venue.snapshot, "date": date, "description": description])
      }
